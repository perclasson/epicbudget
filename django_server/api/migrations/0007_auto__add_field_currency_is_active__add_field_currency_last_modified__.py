...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'api_currency', 'is_active')

        # Deleting field 'Currency.last_modified'
        db.delete_column(u'api_currency', 'last_modified')

        # Deleting field 'EntryType.last_modified'
        db.delete_column(u'api_entrytype', 'last_modified')

        # Deleting field 'Budget.last_modified'
        db.delete_column(u'api_budget', 'last_modified')

        # Deleting field 'Entry.last_modified'
        db.delete_column(u'api_entry', 'last_modified')
