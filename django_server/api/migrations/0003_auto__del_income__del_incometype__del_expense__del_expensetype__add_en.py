...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Budget.expense_type'
        db.alter_column(u'api_budget', 'expense_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.EntryType']))
        # Adding field 'Entry.entry_type'
        db.add_column(u'api_entry', 'entry_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.EntryType'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Budget.expense_type'
        db.alter_column(u'api_budget', 'expense_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.ExpenseType']))
        # Deleting field 'Entry.entry_type'
        db.delete_column(u'api_entry', 'entry_type_id')
